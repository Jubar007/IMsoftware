...
//enum ChatMsgType {updateDataBase,acpFriend,getFriendList,logInerro,verLogin,signIn,logIn,ChatMsg,SfileName, RefFile ,
//                   FriendAdd, RefFriend, AcpFriend};//消息类型
enum ChatMsgType {SfileName, RefFile ,
                  FriendAdd, RefFriend, AcpFriend,ChatMsg,logIn,signIn,getFriends, getGroupList,
                  getGroupMeb,acpFriend,deleteFriend,searchFriend,modUsrInfo,
                  logInerro,verLogin,updateDataBase};
