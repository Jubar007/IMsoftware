...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FileCntDlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FileCntDlg_t qt_meta_stringdata_FileCntDlg = {
    {
QT_MOC_LITERAL(0, 0, 10), // "FileCntDlg"
QT_MOC_LITERAL(1, 11, 15), // "createConnToSrv"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11), // "readChatMsg"
QT_MOC_LITERAL(4, 40, 29) // "on_cntClosePushButton_clicked"

    },
    "FileCntDlg\0createConnToSrv\0\0readChatMsg\0"
    "on_cntClosePushButton_clicked"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_FileCntDlg[] = {
...
QT_INIT_METAOBJECT const QMetaObject FileCntDlg::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_FileCntDlg.data,
